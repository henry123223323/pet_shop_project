...
class CheckBillPage extends Component {
    ...
    confirmToPay = async () => {
        ...
        const orderData = {
            ...
            card_last4: "1234", // 可根據 payMethod 決定要不要填
            delivery_method: deliveryData.method || "未選擇",
            receiver_name: deliveryData.name || "未填",
            receiver_phone: deliveryData.phone || "未填",
            receiver_address: deliveryData.address || "未填",
            receipt: receiptData.type || "未填"
        };
