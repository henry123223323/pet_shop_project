                    ...
                    <div className="modal-dialog modal-dialog-scrollable" style={{ maxHeight: '70vh' }}>
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">編輯二手商品</h5>
                            </div>
                            ...
                            <div className="modal-body" style={{ overflowY: 'auto' }}>
                                <form>
                                    ...
                                    <div className="form-group mb-2">
                                        <label>城市</label>
                                        <input type="text" className="form-control" name="city" value={product.city} onChange={this.handleChange} />
                                    </div>

                                    <div className="form-group mb-2">
                                        <label>區域</label>
                                        <input type="text" className="form-control" name="district" value={product.district} onChange={this.handleChange} />
                                    </div>

                                    <div className="form-group mb-2">
                                        <label>新舊程度 (1-5)</label>
                                        <select className="form-control" name="new_level" value={product.new_level} onChange={this.handleChange}>
                                            <option value="">請選擇</option>
                                    ...
                                    <div className="form-group mb-2">
                                        <label>配送方式</label>
                                        <select className="form-control" name="delivery_method" value={product.delivery_method} onChange={this.handleChange}>
                                            <option value="">請選擇</option>
            ...
            return (
                <div className="modal show fade d-block" tabIndex="-1" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
                    <div className="modal-dialog modal-dialog-scrollable" style={{ maxHeight: '70vh' }}>
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">上架二手商品</h5>
                            ...
                            <div className="modal-body" style={{ overflowY: 'auto' }}>
                                <form>
                                    ...
                                    <div className="form-group mb-2">
                                        <label>區域</label>
                                        <input type="text" className="form-control" name="district" onChange={this.handleChange} />
                                    </div>

                                    <div className="form-group mb-2">
                                        <label>新舊程度 (1-5)</label>
                                        <select className="form-control" name="new_level" onChange={this.handleChange}>
                                            <option value="">請選擇</option>
                                            <option value="5">全新</option>
                                            <option value="4">近新</option>
                                            <option value="3">普通</option>
                                    ...
                                    <div className="form-group mb-2">
                                        <label>配送方式</label>
                                        <select className="form-control" name="delivery_method" onChange={this.handleChange}>
                                            <option value="">請選擇</option>
                                            <option value="宅配">宅配</option>
                                            <option value="面交">面交</option>
                                        </select>
            ...
            return (
                <div className="modal show fade d-block" tabIndex="-1" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
                    <div className="modal-dialog modal-dialog-scrollable" style={{ maxHeight: '70vh' }}>
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">查看二手商品</h5>
                                <button type="button" className="btn-close" onClick={this.toggleModal}></button>
                            </div>
                            ...
                            <div className="modal-body" style={{ overflowY: 'auto' }}>
                                <form>
                                    ...
                                    <div className="form-group mb-2">
                                        <label>城市</label>
                                        <input type="text" className="form-control" name="city" value={product.city} disabled />
                                    </div>

                                    <div className="form-group mb-2">
                                        <label>區域</label>
                                        <input type="text" className="form-control" name="district" value={product.district} disabled />
                                    </div>

                                    <div className="form-group mb-2">
                                        <label>新舊程度 (1-5)</label>
                                        <select className="form-control" name="new_level" value={product.new_level} disabled>
                                            <option value="">請選擇</option>
                                            <option value="5">全新</option>
                                            <option value="4">近新</option>
                                            <option value="3">普通</option>
                                    ...
                                    <div className="form-group mb-2">
                                        <label>配送方式</label>
                                        <select className="form-control" name="delivery_method" value={product.delivery_method} disabled>
                                            <option value="">請選擇</option>
                                            <option value="宅配">宅配</option>
                                            <option value="面交">面交</option>
                                        </select>
