        ...
        return (
            ...
            <div className="container-xl">
                ...
                <div className="max-w-4xl mx-auto py-10 px-4">
                    <h3 className="text-3xl font-bold text-center mb-2 bg-primary ">如何養狗狗</h3>
                    {/* 假日期，之後會fetch後端資料顯示上傳時間 */}
                    <p className="text-center text-sm mb-6 paw-text-secondary">{new Date().toLocaleDateString()}
                    </p>
                    <p className="mb-4">
